...
NLOHMANN_JSON_SERIALIZE_ENUM(AttachmentConfigs,
                             {
                                 {NO_ATTACHMENTS, "NO_ATTACHMENTS"},
                                 {LEFT_RIGHT_CORNERS_2, "LEFT_RIGHT_CORNERS_2"},
...
NLOHMANN_JSON_SERIALIZE_ENUM(
    TrajectoryConfigs, {
                           ...
                           {CORNERS_2_UP, "CORNERS_2_UP"},
                           {CORNERS_2_WEARHAT, "CORNERS_2_WEARHAT"},
                           {CORNERS_1_WEARHAT, "CORNERS_1_WEARHAT"},
                           {CORNERS_2_WEARSOCK, "CORNERS_2_WEARSOCK"},
                           {FIXED_POINT_TRAJECTORY, "FIXED_POINT_TRAJECTORY"},
                           {TRAJECTORY_DRESS_TWIRL, "TRAJECTORY_DRESS_TWIRL"},
...
NLOHMANN_JSON_SERIALIZE_ENUM(WindConfig,
                             {
                                 {NO_WIND, "NO_WIND"},
                                 {WIND_CONSTANT, "WIND_CONSTANT"},
                                 {WIND_SIN, "WIND_SIN"},
                                 {WIND_SIN_AND_FALLOFF, "WIND_SIN_AND_FALLOFF"},
                                 {WIND_FACTOR_PER_STEP, "WIND_FACTOR_PER_STEP"},
                             })
...
NLOHMANN_JSON_SERIALIZE_ENUM(PrimitiveConfiguration,
                             {
                                 {PLANE_BUST_WEARHAT, "PLANE_BUST_WEARHAT"},
                                 {SLOPE, "SLOPE"},
                                 {SLOPE_SIMPLIEFIED, "SLOPE_SIMPLIEFIED"},
                                 {PLANE_AND_SPHERE, "PLANE_AND_SPHERE"},
                                 {FOOT, "FOOT"},
                                 {NONE, "NONE"},
                                 {Y0PLANE, "Y0PLANE"},
                                 {BIG_SPHERE, "BIG_SPHERE"},
                             })

enum CameraFocusPointType { ORIGIN, CLOTH_CENTER, PRIM0CENTER, POINT };

NLOHMANN_JSON_SERIALIZE_ENUM(CameraFocusPointType,
                             {
                                 {ORIGIN, "ORIGIN"},
                                 {CLOTH_CENTER, "CLOTH_CENTER"},
                                 {PRIM0CENTER, "PRIM0CENTER"},
                                 {POINT, "POINT"},
                             })
...
// static std::string OUTPUT_PARENT_FOLDER = std::string(SOURCE_PATH) +
// "/output/";

#endif   // NDIFFCLOTH_CONSTANTS_HEADER